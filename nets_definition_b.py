...
def FCN_Seg(self, is_training=True):
    ...
    if self.configuration == 2:
        ...
        concatenation = []
        current_up5 = []
        upsampled_features = TransitionUp_elu(x,320,2,'current_up5')
    ...
    if self.configuration == 3:
        ...
        upsampled_features2 = TransitionUp_elu(convolution_concat,256,2,'current_up3')
        #Shows shape of upsampled_features
    ...
    if self.configuration == 4:
        ...
        # Upsample features maintaining number of features
        upsampled_features = TransitionUp_elu(x,320,2,'current_up1')
        #Shows shape of upsampled_features
        ...
        upsampled_features3 = TransitionUp_elu(convolution_concat2,160,2,'current_up4')
        #Shows shape of upsampled_features
        ...
        #Shows shape of upsampled_features
        print("Configuration 4 forth upsample shape:")
        print(upsampled_features4)
        #Crops upsampled features dim to original input dim
